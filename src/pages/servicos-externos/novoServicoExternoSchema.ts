...
import { temNoMaximoTresCasas } from "./servicoExternoValidacao";

export const novoServicoExternoSchema = z.object({
  producao_id: z.string().min(1, "Selecione uma produção"),
  prestador_id: z.string().min(1, "Selecione um prestador"),
  tipo: z.enum(TIPOS_SERVICO_EXTERNO, { message: "Selecione o tipo de serviço externo" }),
...
export type NovoServicoExternoForm = z.infer<typeof novoServicoExternoSchema>;
