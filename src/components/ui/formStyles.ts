export const fieldClass =
  "mt-1 min-h-11 w-full rounded-md border border-control-border bg-surface px-3 py-2 text-base text-ink transition-colors placeholder:text-muted focus:border-action focus:outline-none focus:ring-2 focus:ring-action focus:ring-offset-2 motion-reduce:transition-none sm:text-sm";
...
const buttonVariantClasses: Record<ButtonVariant, string> = {
  ...
  ghost: "px-2 py-1 font-medium text-action hover:bg-page active:bg-page",
  "ghost-danger": "px-2 py-1 font-medium text-danger-strong hover:bg-danger-bg active:bg-danger-bg",
};
